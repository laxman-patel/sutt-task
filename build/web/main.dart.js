...
define('zapp_user_main', ['dart_sdk', 'flutter_sdk'], (function load__zapp_user_main(dart_sdk, flutter_sdk) {
  ...
  var T = {
    ...
    dynamicToDropdownMenuItemOfString: () => (T.dynamicToDropdownMenuItemOfString = dart.constFn(dart.fnType(T.DropdownMenuItemOfString(), [dart.dynamic])))(),
  ...
  dart.defineLazy(CT, {
    ...
    get C2() {
      return C[2] = dart.constMap(core.String, core.String, ["content-type", "application/x-www-form-urlencoded", "X-RapidAPI-Key", "b86611b0fdmsh0cc804dcb662c70p1c6b8bjsn4824cc4241d5", "X-RapidAPI-Host", "google-translate113.p.rapidapi.com"]);
    },
    get C3() {
  ...
  main.MyApp = class MyApp extends framework.StatelessWidget {
    build(context) {
      return new app.MaterialApp.new({title: "Translation App", theme: theme_data.ThemeData.new({primarySwatch: colors.Colors.blue}), home: new main.HomeScreen.new()});
    }
  ...
  var _inputText = dart.privateName(main, "_inputText");
  var _translatedText = dart.privateName(main, "_translatedText");
  var _targetLanguage = dart.privateName(main, "_targetLanguage");
  var _detectedLanguage = dart.privateName(main, "_detectedLanguage");
  var _availaibleLangauges = dart.privateName(main, "_availaibleLangauges");
  var _getAvailaibleLanguages = dart.privateName(main, "_getAvailaibleLanguages");
  var _detectText = dart.privateName(main, "_detectText");
  var _translateText = dart.privateName(main, "_translateText");
  ...
  main._HomeScreenState = class _HomeScreenState extends framework.State$(main.HomeScreen) {
    [_getAvailaibleLanguages]() {
      return async.async(dart.void, (function* _getAvailaibleLanguages() {
        let response = (yield http.get(core.Uri.parse("https://google-translate113.p.rapidapi.com/api/v1/translator/support-languages"), {headers: new (T.IdentityMapOfString$String()).from(["X-RapidAPI-Key", "b86611b0fdmsh0cc804dcb662c70p1c6b8bjsn4824cc4241d5", "X-RapidAPI-Host", "google-translate113.p.rapidapi.com"])}));
        if (response.statusCode === 200) {
          this.setState(dart.fn(() => {
            this[_availaibleLangauges] = core.List.as(dart.dsend(dart.dsend(convert.jsonDecode(response.body), 'map', [dart.fn(item => dart.dsend(item, '_get', ["code"]), T.dynamicTodynamic())]), 'toList', []));
          }, T.VoidTovoid()));
        } else {
          core.print(response.body);
          dart.throw(core.Exception.new("Failed to load"));
        }
      }).bind(this));
    }
    [_detectText]() {
      return async.async(dart.void, (function* _detectText() {
        let response = (yield http.post(core.Uri.parse(main._HomeScreenState.api_uri), {headers: main._HomeScreenState._headers, body: new (T.IdentityMapOfString$String()).from(["text", this[_inputText]])}));
        if (response.statusCode === 200) {
          this.setState(dart.fn(() => {
            this[_detectedLanguage] = core.String.as(dart.dsend(convert.jsonDecode(response.body), '_get', ["source_lang_code"]));
            core.print(dart.dsend(convert.jsonDecode(response.body), '_get', ["source_lang_code"]));
          }, T.VoidTovoid()));
        } else {
          core.print(response.body);
          dart.throw(core.Exception.new("Failed to load"));
    ...
    [_translateText]() {
      return async.async(dart.void, (function* _translateText() {
        let response = (yield http.post(core.Uri.parse("https://google-translate113.p.rapidapi.com/api/v1/translator/text"), {headers: main._HomeScreenState._headers, body: new (T.IdentityMapOfString$String()).from(["from", this[_detectedLanguage], "to", this[_targetLanguage], "text", this[_inputText]])}));
        if (response.statusCode === 200) {
          this.setState(dart.fn(() => {
            this[_translatedText] = core.String.as(dart.dsend(convert.jsonDecode(response.body), '_get', ["trans"]));
          }, T.VoidTovoid()));
        } else {
          core.print(response.body);
          dart.throw(core.Exception.new("Failed to load"));
    ...
    initState() {
      super.initState();
      this[_getAvailaibleLanguages]();
    }
    build(context) {
      return new scaffold.Scaffold.new({appBar: new app_bar.AppBar.new({title: new text.Text.new("Translation App")}), body: new basic.Padding.new({padding: C[1] || CT.C1, child: new basic.Column.new({children: T.JSArrayOfWidget().of([new text_field.TextField.new({onChanged: dart.fn(value => {
                  this.setState(dart.fn(() => {
                    this[_inputText] = value;
                  }, T.VoidTovoid()));
                }, T.StringTovoid())}), new (T.DropdownButtonOfString()).new({value: this[_targetLanguage], onChanged: dart.fn(newValue => {
                  this.setState(dart.fn(() => {
                    let t0;
                    this[_targetLanguage] = (t0 = newValue, t0 == null ? "" : t0);
                  }, T.VoidTovoid()));
                }, T.StringNTovoid()), items: this[_availaibleLangauges][$map](T.DropdownMenuItemOfString(), dart.fn(value => new (T.DropdownMenuItemOfString()).new({value: T.StringN().as(value), child: new text.Text.new(core.String.as(value))}), T.dynamicToDropdownMenuItemOfString()))[$toList]()}), new elevated_button.ElevatedButton.new({onPressed: dart.bind(this, _detectText), child: new text.Text.new("Detect")}), new elevated_button.ElevatedButton.new({onPressed: dart.bind(this, _translateText), child: new text.Text.new("Translate")}), new text.Text.new(this[_detectedLanguage]), new text.Text.new(this[_translatedText])])})})});
    }
    static ['_#new#tearOff']() {
      return new main._HomeScreenState.new();
    }
  ...
  (main._HomeScreenState.new = function() {
    ...
    this[_availaibleLangauges] = ["en", "fr"];
  ...
  dart.setMethodSignature(main._HomeScreenState, () => ({
    ...
    [_getAvailaibleLanguages]: dart.fnType(async.Future$(dart.void), []),
    [_detectText]: dart.fnType(async.Future$(dart.void), []),
    [_translateText]: dart.fnType(async.Future$(dart.void), []),
    build: dart.fnType(framework.Widget, [framework.BuildContext])
  }));
  ...
  dart.setFieldSignature(main._HomeScreenState, () => ({
    ...
    [_translatedText]: dart.fieldType(core.String),
    [_targetLanguage]: dart.fieldType(core.String),
    [_detectedLanguage]: dart.fieldType(core.String),
    [_availaibleLangauges]: dart.fieldType(core.List)
  }));
  dart.setStaticFieldSignature(main._HomeScreenState, () => ['_headers', 'api_uri']);
  dart.defineLazy(main._HomeScreenState, {
    /*main._HomeScreenState._headers*/get _headers() {
      return C[2] || CT.C2;
    },
    /*main._HomeScreenState.api_uri*/get api_uri() {
      return "https://google-translate113.p.rapidapi.com/api/v1/translator/detect-language";
    }
  }, false);
  ...
  typed_queue.Uint8Queue = class Uint8Queue extends typed_queue._IntQueue$(typed_data.Uint8List) {
    ...
    [_add$](element) {
      return dart.throw(core.NoSuchMethodError.withInvocation(this, new core._Invocation.method(C[26] || CT.C26, null, [element])));
    }
    get [_head$0]() {
      return dart.throw(core.NoSuchMethodError.withInvocation(this, new core._Invocation.getter(C[27] || CT.C27)));
    }
    [_writeToList$](target) {
      return dart.throw(core.NoSuchMethodError.withInvocation(this, new core._Invocation.method(C[28] || CT.C28, null, [target])));
    }
    [_grow$]() {
      return dart.throw(core.NoSuchMethodError.withInvocation(this, new core._Invocation.method(C[29] || CT.C29, null, [])));
    }
    [_preGrow$](newElementCount) {
      return dart.throw(core.NoSuchMethodError.withInvocation(this, new core._Invocation.method(C[30] || CT.C30, null, [newElementCount])));
    }
    get [_table$0]() {
      return dart.throw(core.NoSuchMethodError.withInvocation(this, new core._Invocation.getter(C[31] || CT.C31)));
    }
    get [_tail$0]() {
      return dart.throw(core.NoSuchMethodError.withInvocation(this, new core._Invocation.getter(C[32] || CT.C32)));
    }
    set [_head$0](value) {
    ...
    set [_tail$0](value) {
      return dart.throw(core.NoSuchMethodError.withInvocation(this, new core._Invocation.setter(C[35] || CT.C35, value)));
    }
  };
